...
/*
 *
 * There is an with uglify transpiling classes, so using babel converted version
 *
 * see: http://stackoverflow.com/questions/36482076/how-to-uglify-javascript-classes
 *
 */
...
const Inline = Quill.import('blots/inline.js');
